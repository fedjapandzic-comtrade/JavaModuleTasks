...
public class Main {
    public static void main(String args[]) throws MissingFileException {
        Main main = new Main();
        try{
            String createdFile = "C:\\Users\\fedjap\\IdeaProjects\\JavaModuleTasks\\src\\TaskBalloonAssignment\\result.txt";
            String readingFile = "C:\\Users\\fedjap\\IdeaProjects\\JavaModuleTasks\\src\\TaskBalloonAssignment\\text.txt";
